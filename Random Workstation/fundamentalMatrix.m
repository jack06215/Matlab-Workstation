...
C2_F = inv(C1_Intrinsic(:,1:3).') * tx * RC2 * inv(C2_Intrinsic(:,1:3));
...
for i = 1:num_of_points
    ...
    plot(x2,y2(i,:), 'Color', 'b');
    axis square;
    xlim([-600 600]);
    ylim([-600 600]);
end
%% 9. Draw the epipole for each camera
oc2_resptow = [c1Kc2(1:3,4);1];
oc2_I1 = C1_Intrinsic * C1_Extrinsic * oc2_resptow;
oc2_I1 = oc2_I1 / oc2_I1(3);

oc1_resptow = [0;0;0;1];
oc1_I2 = C2_Intrinsic * C2_Extrinsic * oc1_resptow;
