function [ lines ] = DummyTest_getLines( img_bw, minLen )
    ...
    % remove border edges
    im_canny([1 2 3 4 end-3 end-2 end-1 end], :) = 0;
    im_canny(:, [1 2 3 4 end-3 end-2 end-1 end]) = 0;
    ...
    % a_ind ranges from 1 to num_dir with bin centered around pi/2(vertical line)
    ...
    %% 6. Line fitting to point  
    % from[Kahn et al., 1990] P. Kahn, L. Kitchen, and E. Riseman. A fast line 
    % finder for vision-guided robot navigation.
        for id = 1:num_edges
