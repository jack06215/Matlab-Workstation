%GEOM2D Geometric Computing Toolbox
% Version 1.1 06-June-2011 .
%
%   GEOM2D Provides low-level functions for geometric computing. It is
%   possible to create, display, compute intersections... of various
%   geometrical primitives, in 2D.
%
